...
class EditorVC: UIViewController {
    ...
    @IBOutlet weak var editorTextView: QEDTextView! {
        didSet {
            //editorTextView.autoresizingMask = UIViewAutoresizingFlexibleWidth|UIViewAutoresizingFlexibleHeight
            editorTextView.autoresizingMask = [.flexibleWidth, .flexibleHeight]
